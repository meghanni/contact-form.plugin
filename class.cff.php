...
class cff
{
    ...
    function RegisterScripts() {
        ...
        wp_register_script('jquery-validate', 
                CFF_PLUGIN_URL . '/js/jquery.validate.min.js', 
                array('jquery'),'1.10.0',true);
        
        wp_register_script('jquery-meta', 
                CFF_PLUGIN_URL . '/js/jquery.metadata.js', 
                array('jquery'),'4187',true);
        
        wp_register_script('jquery-validate-contact-form', 
                CFF_PLUGIN_URL . '/js/jquery.validate.contact.form.js', 
                array('jquery'),'1.00',true);        
        
        wp_register_style( 'bootstrap', 
                CFF_PLUGIN_URL . '/css/bootstrap-forms.min.css', 
                null, '2.3.1');
    ...
    function Upgrade() {
        ...
        if ( $updated )
            update_option('cff_options',$option);
