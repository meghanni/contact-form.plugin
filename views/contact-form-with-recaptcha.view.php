  ...
  <div class="control-group<?php 
    if (isset($contact->Errors['email'])) echo ' error'; ?>">
     ...
     <div class="controls">
       ...
       <span for="cscf[email]" generated="true" class="help-inline"><?php if (isset($contact->Errors['email'])) echo $contact->Errors['email']; ?></span>
     </div>
  </div>
  ...
  <div class="control-group<?php 
    if (isset($contact->Errors['confirm-email'])) echo ' error'; ?>">
     ...
     <div class="controls">
       ...
       <span for="cscf[confirm-email]" generated="true" class="help-inline"><?php if (isset($contact->Errors['confirm-email'])) echo $contact->Errors['confirm-email']; ?></span>
     </div>
  </div>              
 ...
 <div class="control-group<?php 
    if (isset($contact->Errors['name'])) echo ' error'; ?>">
     ...
     <div class="controls">
       ...
       <span for="cscf[name]" generated="true" class="help-inline"><?php if (isset($contact->Errors['name'])) echo $contact->Errors['name']; ?></span>
     </div>
  </div>  
  ...
  <div class="control-group<?php 
    if (isset($contact->Errors['message'])) echo ' error'; ?>">
     ...
     <div class="controls">
       ...
       <span for="cscf[message]" generated="true" class="help-inline"><?php if (isset($contact->Errors['message'])) echo $contact->Errors['message']; ?></span>
     </div>
  </div>
